...
마지막 갱신: 2026-09-01 11:28:07 KST
...
- 이번 작업 범위(1.2): 통합검색이 중심인 첫 화면, 샘플임을 명시한 많이 본 주제 TOP5, 최근 추가·변경 기록, 샘플 주제 바로가기를 실제 미리보기 UI로 구현한다. 검색 결과 A/B 구조는 1.3 이후로 남긴다.
