...
마지막 갱신: 2026-09-01 11:31:05 KST
...
- 사용자 검토 포인트(1.2): TOP5와 최근 기록의 위치/크기, 첫 화면 정보량, 검색창 아래 설명, 주제 바로가기 노출 방식.
...
- 관련 커밋: `4b80a91215e2dd46ec4c637eb1edc33dd1554ecd`, `af9ba9cc33c9b8afb15f2c5c88f0cd28d33932f2`, `52f7b9ce4c59479aa7878d426464ede365316921`, `779a2f367dbdb874e1b417762e07267a5767257e`, `c08a615096dfc12bc0c1ee46215d464be37b3d7c`, `a0a7fe93936301f237df25b9c42b2436918b3048`
- 다음 행동: 사용자가 실제 `/archive-v1/` 첫 화면을 보고 1.2를 승인하거나 수정점을 제시한다. 수정이 필요하면 Roadmap 규칙에 따라 새 소번호를 추가하고, 승인되면 1.3으로 이동한다.

### 2026-09-01 11:28:07 KST — GPT — 1.2 시작

- 사용자 승인으로 Roadmap `1.2 Archive 첫 화면 제작`을 시작함.
- `1.2` 범위 밖인 검색 결과 A/B 본설계(`1.3`, `1.4`)와 관리자 기능(`2.x`)은 이번 작업에서 진행하지 않음.
- TOP5 실제 조회 데이터는 아직 없으므로 측정값인 것처럼 표시하지 않고 샘플임을 명확히 표기할 예정.
