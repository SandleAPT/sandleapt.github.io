(function(){
  ...
  const titles={dashboard:'현재 작업 홈',meetingImport:'3. 회의록 → Archive',register:'2.2 새 자료 등록',visibility:'2.3 공개 등급',classification:'2.4 분류 검토',relations:'2.4 관계 검토',publish:'발행 대기',meeting:'기존 회의 작성'};
