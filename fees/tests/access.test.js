...
const context={DATA:null,document:{querySelectorAll:s=>s==='.tabs button'?buttons:[],getElementById:id=>({classList:{add(){selected.push(id);}}})},location:{reload(){}},appBoot(){boots++},appShowGate(){gates++},loadAudit(){loads.push('audit')},loadAuditChecks(){loads.push('auditcheck')}};
